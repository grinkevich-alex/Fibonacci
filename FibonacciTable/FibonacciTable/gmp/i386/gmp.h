...
#define __GMP_CFLAGS "-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.1.sdk/ -Wno-error -Wno-implicit-function-declaration -miphoneos-version-min=8.0 -arch i386 -DNO_ASM"
